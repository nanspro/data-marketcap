...
from app.util import (
    ...
    init_new_ddo)
from app.auth_util import compare_eth_addresses, sanitize_addresses
from plecos.plecos import (
    is_valid_dict_remote,
    list_errors_dict_remote,
)

from app.events.constants import EVENT_METADATA_CREATED, EVENT_METADATA_UPDATED
from app.events.metadata_updater import MetadataUpdater
from app.events.util import get_metadata_contract, get_datatoken_info
...
class EventsMonitor:
    ...
    def run_monitor(self):
        ...
        logger.info(f'something {first_update}')
        while True:
            try:
